...
Revision ID: 53ae74461f4a
Revises: 0581b622ec12
Create Date: 2022-05-28 16:11:11.434550
...
revision = '53ae74461f4a'
down_revision = '0581b622ec12'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('website_link', sa.String(length=30), nullable=True),
